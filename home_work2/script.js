...
// Якщо довжина поточного слова більша за довжину найдовшого слова, ми оновлюємо значення longestWord на поточне слово.

// Після завершення циклу, змінна longestWord міститиме найдовше слово з рядка, і воно повертається як результат функції.
...
// Після завершення циклу, масив numbers міститиме усі цілі числа від min до max, і він повертається як результат функції.
